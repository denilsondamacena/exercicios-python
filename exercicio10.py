'''10. Implemente um sistema de validação de CPF que verifique se o formato está correto,
calcule os dígitos verificadores e trate todas as exceções possíveis.
'''
cpf_original = None
cpf_valido = False
